...
func DefaultDevNetwork(tenGateway bool, numNodes int, numSimWallets int) *InMemDevNetwork {
	// Default sim currently uses 4 L1 nodes. Obscuro nodes: 1 seq, 3 validators
